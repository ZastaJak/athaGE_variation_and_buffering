...
WT_CHH_A<-analyseReadsInsideRegionsForCondition(bare_grange, WT, "CHH")
met11_CHH_A<-analyseReadsInsideRegionsForCondition(bare_grange, met11, "CHH")
met13_CHH_A<-analyseReadsInsideRegionsForCondition(bare_grange, met13, "CHH")

save(WT_CHH_A, file = "WT_CHH_A.RData")
save(met11_CHH_A, file = "met11_CHH_A.RData")
save(met13_CHH_A, file = "met13_CHH_A.RData")