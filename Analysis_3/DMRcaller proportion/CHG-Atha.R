...
WT_CHG_A<-analyseReadsInsideRegionsForCondition(bare_grange, WT, "CHG")
met11_CHG_A<-analyseReadsInsideRegionsForCondition(bare_grange, met11, "CHG")
met13_CHG_A<-analyseReadsInsideRegionsForCondition(bare_grange, met13, "CHG")

save(WT_CHG_A, file = "WT_CHG_A.RData")
save(met11_CHG_A, file = "met11_CHG_A.RData")
save(met13_CHG_A, file = "met13_CHG_A.RData")