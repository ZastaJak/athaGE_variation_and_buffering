...
WT_CHH_P<-analyseReadsInsideRegionsForCondition(bare_grange, WT, "CHH")
met11_CHH_P<-analyseReadsInsideRegionsForCondition(bare_grange, met11, "CHH")
met13_CHH_P<-analyseReadsInsideRegionsForCondition(bare_grange, met13, "CHH")

save(WT_CHH_P, file = "WT_CHH_P.RData")
save(met11_CHH_P, file = "met11_CHH_P.RData")
save(met13_CHH_P, file = "met13_CHH_P.RData")