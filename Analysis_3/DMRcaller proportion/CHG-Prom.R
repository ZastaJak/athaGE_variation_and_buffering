...
WT_CHG_P<-analyseReadsInsideRegionsForCondition(bare_grange, WT, "CHG")
met11_CHG_P<-analyseReadsInsideRegionsForCondition(bare_grange, met11, "CHG")
met13_CHG_P<-analyseReadsInsideRegionsForCondition(bare_grange, met13, "CHG")

save(WT_CHG_P, file = "WT_CHG_P.RData")
save(met11_CHG_P, file = "met11_CHG_P.RData")
save(met13_CHG_P, file = "met13_CHG_P.RData")