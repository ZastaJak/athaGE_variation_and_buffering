...
WT_CG_A<-analyseReadsInsideRegionsForCondition(bare_grange, WT, "CG")
met11_CG_A<-analyseReadsInsideRegionsForCondition(bare_grange, met11, "CG")
met13_CG_A<-analyseReadsInsideRegionsForCondition(bare_grange, met13, "CG")

save(WT_CG_A, file = "WT_CG_A.RData")
save(met11_CG_A, file = "met11_CG_A.RData")
save(met13_CG_A, file = "met13_CG_A.RData")