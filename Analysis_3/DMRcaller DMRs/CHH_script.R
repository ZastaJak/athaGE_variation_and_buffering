...
DMRsCHH_WT_to_met1_1 <- computeDMRs(WT_corrected,
                          met1_1_corrected,
                          regions = NULL,
                          context = "CHH",
                          method = "bins",
...
DMRsCHH_WT_to_met1_3 <- computeDMRs(WT_corrected,
                          met1_3_corrected,
                          regions = NULL,
                          context = "CHH",
                          method = "bins",
...
DMRsCHH_met1_1_to_met1_3 <- computeDMRs(met1_1_corrected,
                          met1_3_corrected,
                          regions = NULL,
                          context = "CHH",
                          method = "bins",
...
save(DMRsCHH_WT_to_met1_1, file = "CHH-WT-met1_1.RData")
save(DMRsCHH_WT_to_met1_3, file = "CHH-WT-met1_3.RData")
save(DMRsCHH_met1_1_to_met1_3, file = "CHH-met1_1-met1_3.RData")