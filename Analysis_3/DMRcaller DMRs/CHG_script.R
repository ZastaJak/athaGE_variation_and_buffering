...
DMRsCHG_WT_to_met1_1 <- computeDMRs(WT_corrected,
                          met1_1_corrected,
                          regions = NULL,
                          context = "CHG",
                          method = "bins",
                          ...
                          cores = 1)
DMRsCHG_WT_to_met1_3 <- computeDMRs(WT_corrected,
                          met1_3_corrected,
                          regions = NULL,
                          context = "CHG",
                          method = "bins",
                          ...
                          minReadsPerCytosine = 4,
                          cores = 1)
DMRsCHG_met1_1_to_met1_3 <- computeDMRs(met1_1_corrected,
                          met1_3_corrected,
                          regions = NULL,
                          context = "CHG",
                          method = "bins",
...
save(DMRsCHG_WT_to_met1_1, file = "CHG-WT-met1_1.RData")
save(DMRsCHG_WT_to_met1_3, file = "CHG-WT-met1_3.RData")
save(DMRsCHG_met1_1_to_met1_3, file = "CHG-met1_1-met1_3.RData")